...
import pytest
from jupyter_matlab_kernel.kernels.labextension_comm.communication import LabExtensionCommunication
...
def test_comm_open_creates_comm(labext_comm, mocker, mock_stream, mock_ident, mock_comm):
...
def test_comm_close_with_non_matching_comm_id(labext_comm, mocker, mock_stream, mock_ident, mock_comm):
