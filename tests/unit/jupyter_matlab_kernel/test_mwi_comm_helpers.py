...
async def test_send_eval_request_to_matlab_with_error(monkeypatch, matlab_proxy_fixture):
...
async def test_send_eval_request_to_matlab_bad_request(monkeypatch, matlab_proxy_fixture):
...
async def test_send_eval_request_to_matlab_missing_eval_response(monkeypatch, matlab_proxy_fixture):
...
async def test_read_eval_response_from_file_success_with_file(matlab_proxy_fixture):
    ...
    test_data = [{"type": "stream", "content": {"name": "stdout", "text": "Hello World"}}]
...
async def test_read_eval_response_from_file_error_with_message_faults(matlab_proxy_fixture):
    ...
    with pytest.raises(Exception, match="Failed to execute. Operation may have been interrupted by user."):
        await matlab_proxy_fixture._read_eval_response_from_file(eval_response)


async def test_read_eval_response_from_file_error_without_message_faults(matlab_proxy_fixture):
...
async def test_read_eval_response_from_file_handles_file_deletion_error(matlab_proxy_fixture, monkeypatch):
...
async def test_read_eval_response_from_file_with_empty_file_content(matlab_proxy_fixture):
...
async def test_read_eval_response_from_file_with_whitespace_only_content(matlab_proxy_fixture):
